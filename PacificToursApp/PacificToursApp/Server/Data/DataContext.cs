...
namespace PacificToursApp.Server.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SingleSuite>().HasData(
            new SingleSuite
            {
                SingleSuiteId = 1,
                SingleSuitePrice = 375.00m,
                SingleSuiteAvailableSpaces = 20,
            },
            new SingleSuite
            {
                SingleSuiteId = 2,
            ...
            modelBuilder.Entity<DoubleSuite>().HasData(
            new DoubleSuite
            {
                DoubleSuiteId = 1,
                DoubleSuitePrice = 775.00m,
                DoubleSuiteAvailableSpaces = 20,
            },
            new DoubleSuite
            {
                DoubleSuiteId = 2,
            ...
            modelBuilder.Entity<FamilySuite>().HasData(
            new FamilySuite
            {
                FamilySuiteId = 1,
                FamilySuitePrice = 950.00m,
                FamilySuiteAvailableSpaces = 20,
            },
            new FamilySuite
            {
                FamilySuiteId = 2,
            ...
            .HasOne(h => h.SingleSuite)
            .WithMany()
            .HasForeignKey(h => h.SingleSuiteId);

            modelBuilder.Entity<Hotel>()
            .HasOne(h => h.DoubleSuite)
            .WithMany()
            .HasForeignKey(h => h.DoubleSuiteId);

            modelBuilder.Entity<Hotel>()
            .HasOne(h => h.FamilySuite)
            .WithMany()
            .HasForeignKey(h => h.FamilySuiteId);
        }
